...
namespace AOC.Perf.BLL
{
	...
	{
		private readonly AOC.Perf.DAL.DBVERSION dal=new AOC.Perf.DAL.DBVERSION();
		public DBVERSION()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public AOC.Perf.Model.DBVERSION GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "DBVERSIONModel-" ;
			...
			return (AOC.Perf.Model.DBVERSION)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<AOC.Perf.Model.DBVERSION> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<AOC.Perf.Model.DBVERSION> DataTableToList(DataTable dt)
		{
			List<AOC.Perf.Model.DBVERSION> modelList = new List<AOC.Perf.Model.DBVERSION>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				AOC.Perf.Model.DBVERSION model;
